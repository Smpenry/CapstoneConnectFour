package src; /**
 * ConnectFourTest tests the data backend src.ConnectFour class for
 * the src.ConnectFour project.
 * @author sarah penry
 * @version 05/22/2023
 */
...
/**
 * constructor for connect four test
 */
public class ConnectFourTest {
	 ...
	 * Tests gameOver method of src.ConnectFour
	 */
	@Test
	 ...
	 * Tests getWinner method of src.ConnectFour
	 */
	@Test
